...
function raffraichirimagesExamensMorphologiques(typeExamen)
{
     ...
     $.ajax({
        type: 'POST',
        url: tabUrl[0]+'public/archivage/images-examens-morphologiques',
 ...
 $( "#confirmation" ).dialog({
  ...
  buttons: {
      "Oui": function() {
          ...
          var id_cons = $("#id_cons").val();
          var chemin = tabUrl[0]+'public/archivage/supprimer-image';
          $.ajax({
              type: 'POST',
              url: chemin ,
...
$(function(){
	...
	}, 8000); //Attendre huit secondes avant de s'executer
});
}