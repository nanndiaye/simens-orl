...
class IncidentAccidentPerOperatoireOrlTable {
	...
	public function getIncidentAccidentPerOperatoireOrl($id_cons){
	...
	public function addIncidentAccidentPerOperatoireOrl($data, $id_cons, $id_employe){
		$today = new \DateTime ();
		$date_enregistrement = $today->format ( 'Y-m-d H:i:s' );
		$donnees = array(
				'id_cons' => $id_cons,
				'incident_anesthesique' => $data->incident_anesthesique,
				'groupeIVb' => $data->groupeIVb,
				'groupeIVa' => $data->groupeIVa,
				'incident_chirurgicaux' => $data->incident_chirurgicaux,
				'incident_glandulaire' => $data->incident_glandulaire,
				'incident_tracheotomie' => $data->incident_tracheotomie,
	...
	public function deleteIncidentAccidentPerOperatoireOrl($id){
