...
function visualiser(id){
	 confirmation(id);
	 var cle = id;
     var chemin = tabUrl[0]+'public/secretariat/declarer-deces';
     $.ajax({
         type: 'POST',
         url: chemin ,
         data: $(this).serialize(),  
...
function initialisation(){
	...
	( {
		...
		"sAjaxSource": ""+tabUrl[0]+"public/secretariat/liste-actes-impayes-ajax", 
...
function initialisation2(){
	...
	( {
		...
		"sAjaxSource": ""+tabUrl[0]+"public/secretariat/liste-actes-payes-ajax", 
...
function paiement(id,idDemande,type){ 
    ...
    $.ajax({
        type: 'POST',
        url: tabUrl[0]+'public/secretariat/liste-actes-impayes' ,
...
function reglerFacture(idDemande, idPatient) {
	...
	$.ajax({
        type: 'POST',
        url: tabUrl[0]+'public/secretariat/acte-paye' ,
...
function imprimerFactureActe(idDemande){
	var vart = '/simens/public/secretariat/impression-facture-acte';
