...
class AntecedentOrlTable {
	...
	public function getAntecedentsOrl($id_cons){
	...
	public function addAntecedentsOrl($data, $id_cons, $id_employe){
	...
	public function deleteAntecedentsOrl($id){
