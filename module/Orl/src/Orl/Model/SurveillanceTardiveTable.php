...
class SurveillanceTardiveTable {
...
public function getSurveillanceTardive($id_cons){
	...
	public function addSurveillanceTardive($data, $id_cons, $id_employe_e){
		$today = new \DateTime ();
		...
		$donnees = array(
				...
				'qualite_voix_parlee' => $data->qualite_voix_parlee,
				'qualite_voix_chantee' => $data->qualite_voix_chantee,
				'qualite_cicatrice' => $data->qualite_cicatrice,
				'laryngoscopie_indirecte' => $data->laryngoscopie_indirecte,
				'palpation_cou' => $data->palpation_cou,
				'radiographie_pulmonaire' => $data->radiographie_pulmonaire,
// 				'laryngoscopie_indirecte' => $data->laryngoscopie_indirecte,	
// 				'examens_autres_appareils' => $data->examens_autres_appareils,
	...
	public function deleteSurveillanceTardive($id){
