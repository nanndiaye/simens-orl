...
class MotifHospitalisationOrlTable {
	...
	public function getMotifHospitalisation($id_cons){
	...
	public function addMotifHospitalisaionOrl($data, $id_cons, $id_employe_e){
		$today = new \DateTime ();
		$date_enregistrement = $today->format ( 'Y-m-d H:i:s' );
		
		$donnees = array(
				'id_cons' => $id_cons,
				'tumefaction_cervical_anterieur' => $data->tumefaction_cervical_anterieur,
				'signes_thyroxicose' => $data->signes_thyroxicose,
				'signe_compression' => $data->signe_compression,
				'groupeIa' => $data->groupeIa,
				'groupeIb' => $data->groupeIb,
				'groupeIc' => $data-> 	groupeIc,
	...
	public function deleteMotifHospitalisaionOrl($id){
